...
(define-key global-map (kbd "M-t") 'next-line)
(define-key global-map (kbd "M-n") 'previous-line)
(define-key global-map (kbd "M-s") 'right-char)
;;; }}}

;;; Backup settings {{{
(setq backup-directory-alist '((".*" . "/tmp/emacs-history")))
;;; }}}
