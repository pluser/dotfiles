;;; -*- mode: Emacs-Lisp; coding: utf-8; lisp-body-indent: 2; tab-width: 2; -*-
;;; init.el --- A emacs setting file
;;; Commentary: Heavily personalized Emacs configuration file
;;; Code:
...
(package-invoke 'flycheck-mode 'prog-mode-hook)
...
(package-config 'ox-latex
	(add-to-list 'org-latex-classes '("ltjsarticle" "\\documentclass[12pt,a4paper]{ltjsarticle}
[NO-DEFAULT-PACKAGES]
\\usepackage{amsmath}
...
(package-invoke 'evil-local-mode 'prog-mode-hook)
